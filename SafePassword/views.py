...
def Show(request,aid):
    ...
    key =  palindrome_key(details.key)
    username = decode(details.username, key)
    password = decode(details.password, key)
